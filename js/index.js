...
function loseClickFn(){
	...
	// else if(grade=="one"){
	// 	$(".firstIndex>img").attr("src","images/first.png");
	// 	$(".paipai .oneone").css({'display':"inline-block",'visibility':"visible"}).siblings().css("display","none");
	// 	$(".paipai li").css({"width":"47%","height":"32%"});
	// 	$(".first>.paipai").css({"width":"75%","top":"-8%"});
	// }
